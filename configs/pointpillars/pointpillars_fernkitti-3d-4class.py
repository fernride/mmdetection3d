...
db_sampler = dict(
    ...
    prepare=dict(
        ...
        filter_by_min_points=dict(Car=5, Pedestrian=5, Truck=5, Van=5)),
    rate=1.0,
    sample_groups=dict(Car=15, Pedestrian=15, Truck=15, Van=15))
default_hooks = dict(
    checkpoint=dict(
        by_epoch=True,
        interval=1,
                    ...
                    db_sampler=dict(
                        ...
                        prepare=dict(
                            ...
                            filter_by_min_points=dict(
                                Car=5, Pedestrian=5, Truck=5, Van=5)),
                        rate=1.0,
                        sample_groups=dict(
                            Car=15, Pedestrian=15, Truck=15, Van=15)),
                    type='ObjectSample',
    ...
    dict(
        db_sampler=dict(
            ...
            prepare=dict(
                ...
                filter_by_min_points=dict(Car=5, Pedestrian=5, Truck=5,
                                          Van=5)),
            rate=1.0,
            sample_groups=dict(Car=15, Pedestrian=15, Truck=15, Van=15)),
        type='ObjectSample',
